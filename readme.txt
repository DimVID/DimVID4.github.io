...
https://docs.rarathemes.com/docs/book-landing-page/
...
# Book Landing Page bundles the following third-party resources:
...
Book Landing Page WordPress Theme, Copyright Rara Theme 2015, rarathemes.com
...
== Change Log ==
    ...
    * Added: Tiktok on RARA : social links widget.
    * Fixed: TGMPA plugin installation issue for php 8.
    * Fixed: Fixed the design of default WP blocks.
    * Fixed: Mobile menu load issue on window resize.
    * Removed: Schema function for single post.

    1.2.1
    * Fixed Social Links widget issue
    * Added menu accessibility
    ...
    * Updated breadcrumbs.
    * Removed publisher and image from shchema function.

    1.1.8
    * Upgraded fontawesometo 5.6.3
    * Added enable/disable option of scrollbar

    1.1.7
    * Fixed constant conditional
    ...
    * Made footer link no-follow.
    ...
    1.1.3
    * Mobile menu updated.
    * MatchHeight JS deleted.
    * Minor CSS issue fixed.
    * Schema Markup Added.
    * SEO Issue Fixed.
    * Author Description issue fixed.

    1.1.2
    * Excerpt function revamp.
    * CSS Minor issue Fixed.
    * Customizer Section Navigation Fixed.
    * Pro Available link added.
    ...
    * Privacy Policy link and WP Comment Cookies Consent features were added after 4.9.6 wp installation.
    ...
    1.1.0
    * Header Information sent php error fixed.
    ...
    * Fixed design issue on subscription section.
